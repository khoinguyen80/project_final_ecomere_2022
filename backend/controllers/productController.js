...
const ProductController = {
  ...
  createProduct: (createProduct = tryCatchError(async (req, res, next) => {
    let images = [];
  ...
  // Get All Product
  getAllProducts: tryCatchError(async (req, res, next) => {
  ...
  getAdminProducts: (getAdminProducts = tryCatchError(
    async (req, res, next) => {
